...
data = {
    ...
    "logs_60_SA.txt": np.loadtxt("results/logs_60_oslo1_SA_results.txt"),  # 0.996, segment_size50, all operators
    #"logs60_SA_10k.txt": np.loadtxt("results/logs60_oslo2_SA_10k_results.txt")
}
...
ax.figure.savefig("boxplot_5.png", dpi=300)
# show plot
plt.show()
